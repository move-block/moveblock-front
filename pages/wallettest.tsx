    ...
    return(
        <div className="container mx-auto px-4 place-content-center">
            <Input
                ...
                onChange = {onChange}
            />
            <Button className="items-center mt-2" onClick={() => checkAuth(moduleAddr)}>
                Auth Check
            </Button>
        </div>
    )
    ...
    return(
        <div className="container mx-auto px-4 place-content-center">
            <Input
                ...
                onChange = {onChange}
            />
            <Button className="items-center mt-2" onClick={() => getSignMessagePayload(message)}>
                Sign Message
            </Button>
        </div>
    )
...
const WalletSignTest2 = () => {
  ...
  const payload : TransactionPayload = {
    ...
    type_arguments: [],
    arguments: ["0x44ed46e3943de0ec15ea8edf0a40aa111dc82f8cfcdd82a712ad1352079f21b2", "100000000"],
    function: "0x1::aptos_account::transfer"
  }
  return(
    <Button className="items-center mt-2" onClick={() => simulateFunction(payload)}>
      Test
    </Button>
  )
}
...
const WalletSignTest3 = () => {
  ...
  return(
    <Button className="items-center mt-2" onClick={() => onSignAndSubmitTransaction(payload)}>
      Test
    </Button>
  )
}
